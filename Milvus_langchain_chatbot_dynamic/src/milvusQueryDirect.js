...
async function directMilvusQuery() {
    try {
        ...
        const filterExpression = `(schoolName == "Maplewood Elementary") or (schoolName == "Central High School")`;

        const outputFields = ["docId", "studentName", "leaveReasonText", "leaveStatus", "schoolName"];
