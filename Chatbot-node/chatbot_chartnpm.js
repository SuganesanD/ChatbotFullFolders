...
// console.log('👀 Sample document:', peek);
...
- Do NOT use backticks, markdown formatting, or any explanation — respond ONLY with pure JSON (no \`\`\`json, no text before or after).
